...
import { runText2ImgBlock, runGptBlock, runGptPage, runWhisper } from "./lib/rawCommands";
...
const LogseqApp = () => {
  ...
  React.useEffect(() => {
    ...
    logseq.Editor.registerSlashCommand("text2img", runText2ImgBlock);
    logseq.Editor.registerBlockContextMenuItem("text2img", runText2ImgBlock);
